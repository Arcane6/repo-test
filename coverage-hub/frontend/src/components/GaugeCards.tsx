...
export function GaugeCards() {
  ...
  const { data } = useQuery({
    queryKey: ["actual-gauges", uf, municipio, tecnologia, regional, anf, popUrbana, vennRegion],
    queryFn: () =>
      mobileAccessApi.gauges({ uf, municipio, tecnologia, regional, anf, popUrbana, vennRegion }),
  });
